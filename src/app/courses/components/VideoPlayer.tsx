...
const VideoPlayer: React.FC<any> = ({ videoData }) => {
  ...
  return (
    <div className="mt-4 flex flex-col items-center justify-center px-4 py-16 m-4 bg-gray-100 h-full">
      {/* Title */}
      <h1 className="mt-10 mb-4 text-3xl font-bold text-gray-800">
        {videoName}
      </h1>
